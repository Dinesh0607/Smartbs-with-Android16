...
import 'package:smartbs/screens/components/profile_polygon.dart';
import 'package:smartbs/screens/dashboard/components/leadsdata_screen.dart';
import 'package:smartbs/screens/telecaller/callback_screen.dart';
            ...
            ListTile(
              title: Text("Leads",
                  style: MyText.subhead(context).copyWith(
                      color: Colors.black, fontWeight: FontWeight.w500)),
              leading:
                  Icon(Icons.leaderboard_sharp, size: 25.0, color: Colors.grey),
              onTap: () {
                Get.to(LeadsDataScreen());
              },
            ),
            Divider(),
            ListTile(
              title: Text("Profile",
                  style: MyText.subhead(context).copyWith(
                      color: Colors.black, fontWeight: FontWeight.w500)),
              leading: Icon(Icons.people, size: 25.0, color: Colors.grey),
              onTap: () {
                Get.to(ProfilePolygonRoute());
              },
            ),
            ListTile(
              title: Text("Help",

...
class Utils {
  ...
  static String dateFormatToShow(DateTime dateTime) {
    return DateFormat("MMM dd, yyyy").format(dateTime).toString();
  }

  static String dateTimeFormatToShow(DateTime dateTime) {
    return DateFormat("MMM dd, yyyy hh:mm a").format(dateTime).toString();
  }

  static String timeFormatToShow(DateTime dateTime) {
